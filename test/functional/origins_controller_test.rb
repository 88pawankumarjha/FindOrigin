...
class OriginsControllerTest < ActionController::TestCase
  ...
  test "should create origin" do
    assert_difference('Origin.count') do
      post :create, origin: { cdetail: @origin.cdetail, cname: @origin.cname, pdetail: @origin.pdetail, pname: @origin.pname }
    end
  ...
  test "should update origin" do
    put :update, id: @origin, origin: { cdetail: @origin.cdetail, cname: @origin.cname, pdetail: @origin.pdetail, pname: @origin.pname }
    assert_redirected_to origin_path(assigns(:origin))
  end
